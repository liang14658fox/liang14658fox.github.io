...
features:
  - icon: 🚩
    ...
    details: A precise learning path, combined with step-by-step directed acyclic graphs, detailed project construction from scratch, and ready-to-use code snippets.
  - icon: 🔢
    title: Infer other things from one fact
    details: Use JavaScript to manipulate objects, arrays, and object arrays, repeatedly extracting and replacing them. Various environments are tailored to the configuration process.
  - icon: 🏴‍☠️
    title: Open Source
    details: The content of this document is fully open source and shared (prohibited for commercial purposes), providing online display of open source projects.
  - icon: 🔧
    title: Data structure
    details: Implementing data structures using JavaScript, such as directed acyclic graphs, traversing and modifying various structures.
  - icon: 🌱
    title: Front and rear end separation
    details: Provide front-end and back-end technology stack support for Vue+SpringBoot, massive problem solving, and a one-stop reading experience.
  - icon: 💯 
    title: Simplicity first
    details: A Markdown centric project structure that emphasizes content layout and provides a good reading experience.
---
...
const members = [
  {
    ...
    links: [
      { icon: 'github', link: 'https://github.com/liang14658fox/liang14658fox.github.io/tree/master' },
