...
module.exports = {
  ...
  themeConfig: {
    ...
    sidebar: {
      "/documentcatalog/a_introduce/": autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../documentcatalog/a_introduce"),
        "介绍"
      ),
      "/documentcatalog/b_environment/": autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../documentcatalog/b_environment/a_environmental_construction"),
        "普通项目搭建"
      ).concat(autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../documentcatalog/b_environment/b_dependency_configuration"),
        "相关依赖引入&配置"
      )).concat(autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../documentcatalog/b_environment/c_vitepress"),
        "VitePress项目搭建配置"
      )),
      //JS快速框架
    ...
    footer: {
      message: '只爭朝夕不負韶華',
      copyright: 'Copyright © 2023-PRESENT by LiangYuandong and liang14658fox contributors'
    }
  },
};