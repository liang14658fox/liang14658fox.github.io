...
<span class="line"><span style="color:#24292E;">        }</span></span>
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><h2 id="深度侦听" tabindex="-1">深度侦听 <a class="header-anchor" href="#深度侦听" aria-label="Permalink to &quot;深度侦听&quot;">​</a></h2><p>侦听对象时，对象内部属性变化watch无法侦听到</p><ul><li>深度监听，多用于对象等深层次的数据</li></ul><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-0tYX0" id="tab-_Eke7VK" checked="checked"><label for="tab-_Eke7VK">侦听整个对象</label><input type="radio" name="group-0tYX0" id="tab-ayAX3ia"><label for="tab-ayAX3ia">精确侦听</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> {</span></span>
